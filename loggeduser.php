...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Mankind Healthcare : Log In</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->              
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="index.html"><i class="fa fa-heartbeat"></i>Mankind <span>Healthcare</span></a>              
              <!-- IMG BASED LOGO  -->
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">More Option <span class="fa fa-angle-down"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="404.html">Page1</a></li>
...
@session_start();
$sql = "select * from users where Email='".$_SESSION['eid']."'";
$q = mysqli_query($conn,$sql);
$row = mysqli_fetch_array($q);
echo "<br />Welcome ".$_SESSION['eid'];
print "<br/><h2>Name:-".$row['Name']."</h2>";
print "<br><h2> Email:-".$row['Email']."</h2>";
print "<br><h2> Phone:-".$row['Phone']."</h2>";
print "<br><h2> Gender:-".$row['Gender']."</h2>";
print "<br><h2> DOB:-".$row['DOB']."</h2>";
print "<br/><br/> <img src='".$row['Image']."' height=200 width=200>";
?>
<br/>
<form method="POST" action="logout.php">
<input type="submit" name="1xsd@" value="LOGOUT"/> 
</form>
<br/><br/><br/><br/><br/><br/>
        ...
        <div class="container">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="footer-copyright">
              <p>&copy; Copyright 2015 <a href="index.html">Mankind Healthcare</a></p>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
